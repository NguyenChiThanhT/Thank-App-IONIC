...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_newsapi_service__ = __webpack_require__(78);
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, newsApiService, modalCtrl, alertCtrl, navParams) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_file__ = __webpack_require__(252);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_file_picker__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_newsapi_service__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__home_home__ = __webpack_require__(136);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ListCountstartPage = /** @class */ (function () {
    function ListCountstartPage(navCtrl, navParams, file, storage, filePicker, newsApiService, loadingCtrl, alertCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.file = file;
    ...
    ListCountstartPage.prototype.setBackButtonAction = function () {
        var _this = this;
    ...
    //alert
    ListCountstartPage.prototype.presentAlert = function () {
    ...
    //is loading
    ListCountstartPage.prototype.presentLoadingDefault = function (text) {
        var _this = this;
    ...
    ListCountstartPage.prototype.dowloadFile = function () {
        ...
        this.filePicker.pickFile()
            .then(function (uri) {
            _this.presentLoadingDefault('Loading...');
            ...
            _this.file.readAsText(convertPath, currentName)
                ...
                result.map(function (e) {
                    ...
                    _this.newsApiService.updatePerson(e)
    ...
    ], ListCountstartPage.prototype, "navBar", void 0);
    ListCountstartPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__ionic_native_file_picker__["a" /* IOSFilePicker */],
            __WEBPACK_IMPORTED_MODULE_5__services_newsapi_service__["a" /* NewsApiService */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_file__ = __webpack_require__(252);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_newsapi_service__ = __webpack_require__(78);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_angularfire2__ = __webpack_require__(696);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__firebase_config__ = __webpack_require__(697);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__ionic_native_file_chooser__ = __webpack_require__(698);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ionic_native_file_picker__ = __webpack_require__(356);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NewsApiService = /** @class */ (function () {
    ...
    NewsApiService.prototype.updatePerson = function (parmas) {
        ...
        // @ts-ignore
        var requestOptions = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* RequestOptions */]({ headers: headers });
        var url = "http://nguyenchithanhfpt.atwebpages.com/api/updatelistperson.php";
        return this.http.put(url, parmas, requestOptions)
            .toPromise()
            .then(function (res) { return res.json(); })
            .then(function (resJSON) { return resJSON; })
